...
def create_final_nologo_1page():
    ...
    for m_cell in master._element.xpath('.//w:tc'):
        from docx.table import _Cell
        cell_obj = _Cell(m_cell, master)
        ...
        run1 = p1.add_run("โรงเรียนบ้านแม่ทราย(คุรุราษฎร์เจริญวิทย์)")
        set_font(run1, size=14, bold=True)
        
        p2 = cell_obj.add_paragraph()
        p2.alignment = WD_ALIGN_PARAGRAPH.CENTER
        run2 = p2.add_run("วิชา................................................................................")
        set_font(run2, size=12) # Only Subject, No Topic
    ...
    doc.save("AnswerSheet_Thai_P4_4in1_Final_NoLogo.docx")
    print("Success")

if __name__ == "__main__":
    create_final_nologo_1page()
